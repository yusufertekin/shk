 ...
 */
@Stateless
public class IliskiliTarafTODAO extends GenericDAO<IliskiliTarafTO,Long> implements Serializable {
	
	private static final long serialVersionUID = 1L;
	
	private final String HQL_FIND_BY_DONEM_AND_COMPANY_AND_TIP = "from IliskiliTarafTO t where t.donem = :donem "
	...
	public List<IliskiliTarafTO> findByDonemAndCompanyAndTip(Donem donem, Company company, Long tip)
	{
		...
		List<IliskiliTarafTO> list = em.createQuery(HQL_FIND_BY_DONEM_AND_COMPANY_AND_TIP)
